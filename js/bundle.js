...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (showSlides);
...
function forms (formsSelector, modalTimerId) {
    ...
    function showThanksModal(message) {
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_0__.showModalContent)('.modal', modalTimerId);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_7__.showModalContent)('.modal', modalTimerId), 50000);
    ...
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_7__["default"])('[data-modal]', '.modal', modalTimerId);
